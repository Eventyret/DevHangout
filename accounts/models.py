...
class Profile(models.Model):
	...
	avatar = models.ImageField(upload_to="static/uploads/avatars", max_length=None, blank=True, null=True)
	location = models.CharField(max_length=50, blank=True, null=True)
	website = models.CharField(max_length=50, blank=True, null=True)
	company = models.CharField(max_length=50, blank=True, null=True)
	title = models.CharField(max_length=50, blank=True, null=True)
	backgroundImage = models.ImageField(upload_to="static/uploads/backgrounds", max_length=None, blank=True, null=True)
